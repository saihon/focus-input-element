...
export class Focus {
    ...
    private constructor(scrollOptions: ScrollIntoViewOptions,
                        marksOptions: MarksOptions) {
        this.scrollOptions = scrollOptions;
        this.marksOptions  = marksOptions;
    }

    public static new(scrollOptions: ScrollIntoViewOptions,
                      marksOptions: MarksOptions) {
    ...
    private createElement(tagName: string, top: number, left: number):
        HTMLElement {
    ...
    private getAnimationProperties(top: number,
                                   left: number): PropertyIndexedKeyframes {
    ...
    public on(element: HTMLElement): void {
        ...
        let animation = div.animate(this.getAnimationProperties(top, left),
                                    this.marksOptions.milliseconds);

        animation.addEventListener(
            'finish', () => document.documentElement.removeChild(div));
    }
}